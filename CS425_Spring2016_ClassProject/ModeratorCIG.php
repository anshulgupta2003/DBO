...
<!--		<link href="/CS425ProjectSpring2016/styles/css/site.css" rel="stylesheet" type="text/css">-->
        ...
        <script type="text/javascript" src="/CS425_Spring2016_ClassProject/Scripts/moderatorCIG.js"></script>        
		...
		<section>
			<div class="divInSection">                
                ...
                <?php
                    ...
                    $sql = oci_parse($conn, "SELECT j.memberID, j.groupID, c.NAME 
                                            FROM joinsCIG j
                                            INNER JOIN moderatesCIG m
                                            ON j.GROUPID = m.GROUPID 
                    ...
                    while ($row = oci_fetch_array($sql,OCI_BOTH)) {                       
                        $result[$counter]=array($row[0],$row[1],$row[2]);
                        $counter++;
                    } 
